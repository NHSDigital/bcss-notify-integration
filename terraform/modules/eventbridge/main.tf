...
resource "aws_cloudwatch_event_target" "batch_notification_processor_8am_event_target" {
  rule      = aws_cloudwatch_event_rule.batch_notification_processor_8am_schedule.name # Point to the first rule
...
resource "aws_cloudwatch_event_target" "batch_notification_processor_9am_event_target" {
  rule      = aws_cloudwatch_event_rule.batch_notification_processor_9am_schedule.name # Point to the first rule
